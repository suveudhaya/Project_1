...
def query9():
    ...
    """
    results = execute_query(query)
    st.write("Query 9: Average duration of all videos in each channel and their corresponding channel names")
    display_results_as_table(results)
...
def query_ui():
    st.sidebar.title("Choose a Query")
    selected_query = st.sidebar.selectbox("", ["Query 1", "Query 2", "Query 3", "Query 4", "Query 5","Query 6","Query 7","Query 8","Query 9","Query 10"])
